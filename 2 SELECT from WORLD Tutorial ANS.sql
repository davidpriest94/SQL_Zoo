/*Q1. Read the notes about this table. Observe the result of running this SQL command to show the name, continent and population of all countries.*/
...
SELECT name, ROUND(population/1000000,2) AS 'population(millions)', ROUND(GDP/1000000000,2) AS 'GPD(billions)'
  FROM world
  WHERE continent = 'South America';
...
/*Q13. Equatorial Guinea and Dominican Republic have all of the vowels (a e i o u) in the name. They do not count because they have more than one word in the name.
